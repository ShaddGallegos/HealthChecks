...
## Title
rhel_ai HealthCheck Role

## Synopsis
The rhel_ai role performs product-specific health validation and reporting in the PostInstall_Healthcheck workflow.
...
Run this role through the corresponding top-level runner from /home/sgallego/GIT/HealthChecks:
    ...
    ansible-playbook run_postinstall.yml -e "products=['rhel_ai']"

Apply/remediation mode (opt-in):

    cd /home/sgallego/GIT/HealthChecks
    ansible-playbook run_postinstall.yml -e "products=['rhel_ai'] healthcheck_check_mode_only=false"
...
## Related Files
- PostInstall_Healthcheck/roles/rhel_ai/tasks/main.yml
