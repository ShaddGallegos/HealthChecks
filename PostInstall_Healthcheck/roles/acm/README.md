...
## Title
acm HealthCheck Role

## Synopsis
The acm role performs product-specific health validation and reporting in the PostInstall_Healthcheck workflow.
...
Run this role through the corresponding top-level runner from /home/sgallego/GIT/HealthChecks:
    ...
    ansible-playbook run_postinstall.yml -e "products=['acm']"

Apply/remediation mode (opt-in):

    cd /home/sgallego/GIT/HealthChecks
    ansible-playbook run_postinstall.yml -e "products=['acm'] healthcheck_check_mode_only=false"
...
## Variables
Common role defaults discovered from PostInstall_Healthcheck/roles/acm/defaults/main.yml:
- acm_supported_rhel_major_versions
...
## Related Files
- PostInstall_Healthcheck/roles/acm/tasks/main.yml
- PostInstall_Healthcheck/roles/acm/defaults/main.yml
