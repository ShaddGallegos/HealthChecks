# jboss_webserver Role

## Title
jboss_webserver HealthCheck Role

## Synopsis
The jboss_webserver role performs product-specific health validation and reporting in the PostInstall_Healthcheck workflow.
...
Run this role through the corresponding top-level runner from /home/sgallego/GIT/HealthChecks:
    ...
    ansible-playbook run_postinstall.yml -e "products=['jboss_webserver']"

Apply/remediation mode (opt-in):

    cd /home/sgallego/GIT/HealthChecks
    ansible-playbook run_postinstall.yml -e "products=['jboss_webserver'] healthcheck_check_mode_only=false"
...
## Variables
Common role defaults discovered from PostInstall_Healthcheck/roles/jboss_webserver/defaults/main.yml:
- jboss_webserver_supported_rhel_major_versions
...
## Related Files
- PostInstall_Healthcheck/roles/jboss_webserver/tasks/main.yml
- PostInstall_Healthcheck/roles/jboss_webserver/defaults/main.yml
