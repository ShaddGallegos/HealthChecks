# migration_toolkit Role

## Title
migration_toolkit HealthCheck Role

## Synopsis
The migration_toolkit role performs product-specific health validation and reporting in the PostInstall_Healthcheck workflow.
...
Run this role through the corresponding top-level runner from /home/sgallego/GIT/HealthChecks:
    ...
    ansible-playbook run_postinstall.yml -e "products=['migration_toolkit']"

Apply/remediation mode (opt-in):

    cd /home/sgallego/GIT/HealthChecks
    ansible-playbook run_postinstall.yml -e "products=['migration_toolkit'] healthcheck_check_mode_only=false"
...
## Variables
Common role defaults discovered from PostInstall_Healthcheck/roles/migration_toolkit/defaults/main.yml:
- migration_toolkit_supported_rhel_major_versions
...
## Related Files
- PostInstall_Healthcheck/roles/migration_toolkit/tasks/main.yml
- PostInstall_Healthcheck/roles/migration_toolkit/defaults/main.yml
