# application_foundations Role

## Title
application_foundations HealthCheck Role

## Synopsis
The application_foundations role performs product-specific health validation and reporting in the PostInstall_Healthcheck workflow.
...
Run this role through the corresponding top-level runner from /home/sgallego/GIT/HealthChecks:
    ...
    ansible-playbook run_postinstall.yml -e "products=['application_foundations']"

Apply/remediation mode (opt-in):

    cd /home/sgallego/GIT/HealthChecks
    ansible-playbook run_postinstall.yml -e "products=['application_foundations'] healthcheck_check_mode_only=false"
...
## Variables
Common role defaults discovered from PostInstall_Healthcheck/roles/application_foundations/defaults/main.yml:
- application_foundations_supported_rhel_major_versions
...
## Related Files
- PostInstall_Healthcheck/roles/application_foundations/tasks/main.yml
- PostInstall_Healthcheck/roles/application_foundations/defaults/main.yml
