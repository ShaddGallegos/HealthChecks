# directory_server Role

## Title
directory_server HealthCheck Role

## Synopsis
The directory_server role performs product-specific health validation and reporting in the PostInstall_Healthcheck workflow.
...
Run this role through the corresponding top-level runner from /home/sgallego/GIT/HealthChecks:
    ...
    ansible-playbook run_postinstall.yml -e "products=['directory_server']"

Apply/remediation mode (opt-in):

    cd /home/sgallego/GIT/HealthChecks
    ansible-playbook run_postinstall.yml -e "products=['directory_server'] healthcheck_check_mode_only=false"
...
## Variables
Common role defaults discovered from PostInstall_Healthcheck/roles/directory_server/defaults/main.yml:
- directory_server_supported_rhel_major_versions
...
## Related Files
- PostInstall_Healthcheck/roles/directory_server/tasks/main.yml
- PostInstall_Healthcheck/roles/directory_server/defaults/main.yml
