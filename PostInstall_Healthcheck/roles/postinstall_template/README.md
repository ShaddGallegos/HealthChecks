# postinstall_template Role

## Title
postinstall_template HealthCheck Role

## Synopsis
The postinstall_template role performs product-specific health validation and reporting in the PostInstall_Healthcheck workflow.
...
Run this role through the corresponding top-level runner from /home/sgallego/GIT/HealthChecks:
    ...
    ansible-playbook run_postinstall.yml -e "products=['postinstall_template']"

Apply/remediation mode (opt-in):

    cd /home/sgallego/GIT/HealthChecks
    ansible-playbook run_postinstall.yml -e "products=['postinstall_template'] healthcheck_check_mode_only=false"
...
## Related Files
- PostInstall_Healthcheck/roles/postinstall_template/tasks/main.yml
