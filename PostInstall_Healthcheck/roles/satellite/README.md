...
## Title
satellite HealthCheck Role

## Synopsis
The satellite role performs product-specific health validation and reporting in the PostInstall_Healthcheck workflow.
...
Run this role through the corresponding top-level runner from /home/sgallego/GIT/HealthChecks:
    ...
    ansible-playbook run_postinstall.yml -e "products=['satellite']"

Apply/remediation mode (opt-in):

    cd /home/sgallego/GIT/HealthChecks
    ansible-playbook run_postinstall.yml -e "products=['satellite'] healthcheck_check_mode_only=false"
...
## Variables
Common role defaults discovered from PostInstall_Healthcheck/roles/satellite/defaults/main.yml:
- satellite_product_repos
- satellite_product_prereq_packages
- satellite_product_required_secrets
- satellite_product_required_mounts
- satellite_product_ports
- satellite_supported_rhel_major_versions
- satellite_hosts_export_required_top_level_keys
...
## Related Files
- PostInstall_Healthcheck/roles/satellite/tasks/main.yml
- PostInstall_Healthcheck/roles/satellite/defaults/main.yml
