...
## Title
shared_tuning HealthCheck Role

## Synopsis
The shared_tuning role performs product-specific health validation and reporting in the PostInstall_Healthcheck workflow.
...
Run this role through the corresponding top-level runner from /home/sgallego/GIT/HealthChecks:
    ...
    ansible-playbook run_postinstall.yml -e "products=['shared_tuning']"

Apply/remediation mode (opt-in):

    cd /home/sgallego/GIT/HealthChecks
    ansible-playbook run_postinstall.yml -e "products=['shared_tuning'] healthcheck_check_mode_only=false"
...
## Related Files
- PostInstall_Healthcheck/roles/shared_tuning/tasks/main.yml
