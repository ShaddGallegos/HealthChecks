...
## Title
gitea HealthCheck Role

## Synopsis
The gitea role performs product-specific health validation and reporting in the PostInstall_Healthcheck workflow.
...
Run this role through the corresponding top-level runner from /home/sgallego/GIT/HealthChecks:
    ...
    ansible-playbook run_postinstall.yml -e "products=['gitea']"

Apply/remediation mode (opt-in):

    cd /home/sgallego/GIT/HealthChecks
    ansible-playbook run_postinstall.yml -e "products=['gitea'] healthcheck_check_mode_only=false"
...
## Related Files
- PostInstall_Healthcheck/roles/gitea/tasks/main.yml
