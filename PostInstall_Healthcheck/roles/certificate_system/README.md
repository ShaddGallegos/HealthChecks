# certificate_system Role

## Title
certificate_system HealthCheck Role

## Synopsis
The certificate_system role performs product-specific health validation and reporting in the PostInstall_Healthcheck workflow.
...
Run this role through the corresponding top-level runner from /home/sgallego/GIT/HealthChecks:
    ...
    ansible-playbook run_postinstall.yml -e "products=['certificate_system']"

Apply/remediation mode (opt-in):

    cd /home/sgallego/GIT/HealthChecks
    ansible-playbook run_postinstall.yml -e "products=['certificate_system'] healthcheck_check_mode_only=false"
...
## Variables
Common role defaults discovered from PostInstall_Healthcheck/roles/certificate_system/defaults/main.yml:
- certificate_system_supported_rhel_major_versions
...
## Related Files
- PostInstall_Healthcheck/roles/certificate_system/tasks/main.yml
- PostInstall_Healthcheck/roles/certificate_system/defaults/main.yml
