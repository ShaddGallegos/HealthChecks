...
## Title
aap_eda HealthCheck Role

## Synopsis
The aap_eda role performs product-specific health validation and reporting in the PostInstall_Healthcheck workflow.
...
Run this role through the corresponding top-level runner from /home/sgallego/GIT/HealthChecks:
    ...
    ansible-playbook run_postinstall.yml -e "products=['aap_eda']"

Apply/remediation mode (opt-in):

    cd /home/sgallego/GIT/HealthChecks
    ansible-playbook run_postinstall.yml -e "products=['aap_eda'] healthcheck_check_mode_only=false"
...
## Variables
Common role defaults discovered from PostInstall_Healthcheck/roles/aap_eda/defaults/main.yml:
- aap_eda_supported_rhel_major_versions
...
## Related Files
- PostInstall_Healthcheck/roles/aap_eda/defaults/main.yml
