# single_node_openshift Role

## Title
single_node_openshift HealthCheck Role

## Synopsis
The single_node_openshift role performs product-specific health validation and reporting in the PostInstall_Healthcheck workflow.
...
Run this role through the corresponding top-level runner from /home/sgallego/GIT/HealthChecks:
    ...
    ansible-playbook run_postinstall.yml -e "products=['single_node_openshift']"

Apply/remediation mode (opt-in):

    cd /home/sgallego/GIT/HealthChecks
    ansible-playbook run_postinstall.yml -e "products=['single_node_openshift'] healthcheck_check_mode_only=false"
...
## Variables
- No defaults/main.yml file detected for this role.
...
## Related Files
- PostInstall_Healthcheck/roles/single_node_openshift/tasks/main.yml
