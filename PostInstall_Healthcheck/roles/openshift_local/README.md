# openshift_local Role

## Title
openshift_local HealthCheck Role

## Synopsis
The openshift_local role performs product-specific health validation and reporting in the PostInstall_Healthcheck workflow.
...
Run this role through the corresponding top-level runner from /home/sgallego/GIT/HealthChecks:
    ...
    ansible-playbook run_postinstall.yml -e "products=['openshift_local']"

Apply/remediation mode (opt-in):

    cd /home/sgallego/GIT/HealthChecks
    ansible-playbook run_postinstall.yml -e "products=['openshift_local'] healthcheck_check_mode_only=false"
...
## Related Files
- PostInstall_Healthcheck/roles/openshift_local/tasks/main.yml
